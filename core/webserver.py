...
class ProxyManager:
    ...
    def standard_error(self, error):
        ...
        return send_file("template/404.html"), 404
    ...
    def get_logs(self):
        ...
        if logType == "access":
            ...
            return render_template("template/select_logs.jinja", application_root=self.app.config['APPLICATION_ROOT'])
    ...
    def index(self):
        ...
        return render_template("template/index.jinja", proxy_map=self.nginx_manager.proxy_map, domain=self.nginx_manager.domain, application_root=self.app.config['APPLICATION_ROOT'])
    ...
    def add_route(self):
        ...
        return render_template("template/add_route.jinja", application_root=self.app.config['APPLICATION_ROOT'])
    ...
    def edit_route(self):
        ...
        return render_template("template/edit_route.jinja", application_root=self.app.config['APPLICATION_ROOT'], proxy_map=self.nginx_manager.proxy_map, server_type=server_type, subdomain=subdomain, path=path, protocol=protocol, backend_path=backend_path, srv_record=srv_record)
    ...
    def add_redirect(self):
        ...
        return render_template("template/add_redirect.jinja", application_root=self.app.config['APPLICATION_ROOT'])
    ...
    def reload_nginx(self):
        ...
        return render_template('template/reload.jinja', application_root=self.app.config['APPLICATION_ROOT'])
