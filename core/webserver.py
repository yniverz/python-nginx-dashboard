...
class ProxyManager:
    ...
    def index(self):
        ...
        sorted_http_keys = sorted(self.nginx_manager.proxy_map['http'].keys(), key=lambda x: tuple(map(str, x.split('.'))))
        sorted_http_map = {k: self.nginx_manager.proxy_map['http'][k] for k in sorted_http_keys}
